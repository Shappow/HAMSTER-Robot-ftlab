...
class ChatCompletionRequest(BaseModel):
    # CORRECTIF : On accepte n'importe quel nom de modèle pour éviter l'erreur 422 avec Gradio
    model: str
...
async def lifespan(app: FastAPI):
    ...
    # OPTIMISATION A40 : Chargement natif haute performance (sans compression 4-bit)
...
async def chat_completions(request: ChatCompletionRequest):
    try:
        ...
        # CORRECTIF : Désactivation de la vérification stricte du nom
