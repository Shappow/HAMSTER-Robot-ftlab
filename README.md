...
> **This is a modified version of [HAMSTER](https://hamster-robot.github.io/) optimized for one-command deployment on RunPod GPU instances.**
>
> **これは [HAMSTER](https://hamster-robot.github.io/) を RunPod GPU インスタンスへワンコマンドでデプロイできるよう改良したフォーク版です。**
